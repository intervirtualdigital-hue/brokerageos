...
const stages = [
    ...
    { id: 'valuation', label: 'Valuation Generated' },
    { id: 'verification', label: 'Financial Verification' },
    { id: 'prep', label: 'Asset Preparation' },
    { id: 'market', label: 'Go-to-Market' },
    { id: 'offers', label: 'Diligence & Closing' },
    { id: 'closing', label: 'Mandate Complete' },
];

interface SellerStatusTimelineProps {
    currentStageId: string;
}

export function SellerStatusTimeline({ currentStageId }: SellerStatusTimelineProps) {
        ...
        <Card className="w-full relative overflow-hidden">
            ...
            <CardContent className="pb-8">
                ...
                <div className="hidden md:block relative mt-2">
                    ...
                    {/* Grid is 7 cols. Center of first is 1/14 (7.14%), center of last is 13/14 (92.85%) */}
